...
## Copilot Code Review Rulesets

GitHub Copilot code review can be enabled through repository rulesets. For example, this enables Copilot reviews on pushes to the default branch:
...
| <a name="module_repository"></a> [repository](#module\_repository) | cloudposse/repository/github | 1.6.0 |
